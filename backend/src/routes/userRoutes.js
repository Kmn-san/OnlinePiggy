...
import { changeCurrency, getUser, recoverUser, softDeleteUser, updatePremium, updateProfilePic, updateUser } from "../controller/userController.js";
const router = Router()
...
router.patch("/premium", updatePremium)
